    ...
    <div className="min-h-screen bg-cream-50">
      ...
      <main className="max-w-2xl mx-auto px-4 py-8 pb-24 md:pb-8">
        <div className="flex items-center justify-between mb-6">
          ...
          <Link href="/diary/write" className="btn-primary !w-auto px-5 py-2 text-sm font-ui">
            일기 쓰기
          </Link>
        </div>
        ...
        {recentMoods.length > 0 && (
          <div className="card-pastel p-4 mb-6 flex items-center justify-center gap-3">
            <span className="text-sm text-gray-400 font-ui">최근 기분:</span>
        ...
        <div className="flex gap-2 mb-6">
          {([['all', '전체'], ['mine', '내 일기']] as const).map(([key, label]) => (
            <button
              ...
              className={`px-4 py-1.5 rounded-full text-sm font-ui transition-all ${
                filter === key
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-1">
                        <h3 className="text-base font-bold text-gray-600 truncate font-ui">{diary.title}</h3>
                        {!diary.isShared && (
